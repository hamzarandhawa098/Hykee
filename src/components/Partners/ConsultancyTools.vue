<template>
  <div class="relative text-white py-20">
    ...
    <div class="max-w-6xl mx-auto w-full">
      <div class="relative flex flex-col md:flex-row items-center gap-8 z-10">
        <div class="relative flex-1 text-center md:text-left">
          ...
          <div class="mt-8 space-x-4">
            <Button class="px-6 py-3">{{ section1Button1 }}</Button>
            <Button class="bg-gray-700 px-6 py-3">{{ section1Button2 }}</Button>
          </div>
        </div>
      ...
      ></h2>
      <div
        class="mt-16 flex flex-col md:flex-row items-center gap-8 relative z-10"
      >
        <div class="relative flex-1">
          <img
            :src="leftMobile"
      ...
      <div
        class="mt-16 flex flex-col  md:flex-row justify-between relative z-10"
      >
        ...
        <div class="relative order-first lg:order-last flex justify-center mb-8 lg:mb-0 lg:flex-[-1]">
          <img
            :src="rightMobile"
            alt="Phone Display"
